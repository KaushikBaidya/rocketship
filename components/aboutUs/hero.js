        ...
        <Fade right>
          <div className="mx-5 lg:mx-20 text-center lg:text-left z-10">
            ...
            <h2 className="text-[16px] text-justify lg:text-xl pr-5">
              Our mission is to equip students with the resources to get
              admitted to their dream school and provide career professionals
              with the confidence and skills to land the job.
            </h2>
          </div>
        </Fade>
      </div>
