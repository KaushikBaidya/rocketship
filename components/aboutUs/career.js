...
const Career = () => {
  return (
    <section className="w-full">
      ...
      <div className="max-w-[1600px] grid grid-cols-1 lg:grid-cols-2 h-full  pb-5 lg:pb-28 mx-auto z-10">
        <div className="mx-5 lg:mx-20 text-center lg:text-left z-10">
          ...
          <h2 className="text-[16px] text-justify lg:text-xl p-5">
            ...
            for each position and industry that you target, provide cover letter
            help, share job application advice, conduct mock interviews and
            more. Prepory career coaches believe in you and your career. It’s
            our job to find your job.
          </h2>
        </div>
